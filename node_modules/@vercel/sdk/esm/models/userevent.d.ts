...
export type PayloadFavoriteProjectsAndSpaces = UserEventFavoriteProjectsAndSpaces1 | UserEventFavoriteProjectsAndSpaces2;
...
export type NewOwner = {
    ...
    favoriteProjectsAndSpaces?: Array<UserEventFavoriteProjectsAndSpaces1 | UserEventFavoriteProjectsAndSpaces2> | undefined;
    email: string;
    id: string;
...
/** @internal */
export declare const UserEventFavoriteProjectsAndSpaces2$inboundSchema: z.ZodType<UserEventFavoriteProjectsAndSpaces2, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventFavoriteProjectsAndSpaces2$outboundSchema: z.ZodType<UserEventFavoriteProjectsAndSpaces2$Outbound, z.ZodTypeDef, UserEventFavoriteProjectsAndSpaces2>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventFavoriteProjectsAndSpaces2$ {
    /** @deprecated use `UserEventFavoriteProjectsAndSpaces2$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventFavoriteProjectsAndSpaces2, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventFavoriteProjectsAndSpaces2$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventFavoriteProjectsAndSpaces2$Outbound, z.ZodTypeDef, UserEventFavoriteProjectsAndSpaces2>;
    /** @deprecated use `UserEventFavoriteProjectsAndSpaces2$Outbound` instead. */
    type Outbound = UserEventFavoriteProjectsAndSpaces2$Outbound;
}
export declare function userEventFavoriteProjectsAndSpaces2ToJSON(userEventFavoriteProjectsAndSpaces2: UserEventFavoriteProjectsAndSpaces2): string;
export declare function userEventFavoriteProjectsAndSpaces2FromJSON(jsonString: string): SafeParseResult<UserEventFavoriteProjectsAndSpaces2, SDKValidationError>;
/** @internal */
export declare const UserEventFavoriteProjectsAndSpaces1$inboundSchema: z.ZodType<UserEventFavoriteProjectsAndSpaces1, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const UserEventFavoriteProjectsAndSpaces1$outboundSchema: z.ZodType<UserEventFavoriteProjectsAndSpaces1$Outbound, z.ZodTypeDef, UserEventFavoriteProjectsAndSpaces1>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace UserEventFavoriteProjectsAndSpaces1$ {
    /** @deprecated use `UserEventFavoriteProjectsAndSpaces1$inboundSchema` instead. */
    const inboundSchema: z.ZodType<UserEventFavoriteProjectsAndSpaces1, z.ZodTypeDef, unknown>;
    /** @deprecated use `UserEventFavoriteProjectsAndSpaces1$outboundSchema` instead. */
    const outboundSchema: z.ZodType<UserEventFavoriteProjectsAndSpaces1$Outbound, z.ZodTypeDef, UserEventFavoriteProjectsAndSpaces1>;
    /** @deprecated use `UserEventFavoriteProjectsAndSpaces1$Outbound` instead. */
    type Outbound = UserEventFavoriteProjectsAndSpaces1$Outbound;
}
export declare function userEventFavoriteProjectsAndSpaces1ToJSON(userEventFavoriteProjectsAndSpaces1: UserEventFavoriteProjectsAndSpaces1): string;
export declare function userEventFavoriteProjectsAndSpaces1FromJSON(jsonString: string): SafeParseResult<UserEventFavoriteProjectsAndSpaces1, SDKValidationError>;
/** @internal */
...
/** @internal */
export type PayloadFavoriteProjectsAndSpaces$Outbound = UserEventFavoriteProjectsAndSpaces1$Outbound | UserEventFavoriteProjectsAndSpaces2$Outbound;
/** @internal */
...
export type NewOwner$Outbound = {
    ...
    favoriteProjectsAndSpaces?: Array<UserEventFavoriteProjectsAndSpaces1$Outbound | UserEventFavoriteProjectsAndSpaces2$Outbound> | undefined;
    email: string;
    id: string;
    importFlowGitNamespace?: string | number | null | undefined;
    importFlowGitNamespaceId?: string | number | null | undefined;
