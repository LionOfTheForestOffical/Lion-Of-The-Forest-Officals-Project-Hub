...
/** @internal */
export const GetIntegrationLogDrainsCreatedFrom$inboundSchema = z.nativeEnum(GetIntegrationLogDrainsCreatedFrom);
/** @internal */
export const GetIntegrationLogDrainsCreatedFrom$outboundSchema = GetIntegrationLogDrainsCreatedFrom$inboundSchema;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export var GetIntegrationLogDrainsCreatedFrom$;
(function (GetIntegrationLogDrainsCreatedFrom$) {
    /** @deprecated use `GetIntegrationLogDrainsCreatedFrom$inboundSchema` instead. */
    GetIntegrationLogDrainsCreatedFrom$.inboundSchema = GetIntegrationLogDrainsCreatedFrom$inboundSchema;
    /** @deprecated use `GetIntegrationLogDrainsCreatedFrom$outboundSchema` instead. */
    GetIntegrationLogDrainsCreatedFrom$.outboundSchema = GetIntegrationLogDrainsCreatedFrom$outboundSchema;
})(GetIntegrationLogDrainsCreatedFrom$ || (GetIntegrationLogDrainsCreatedFrom$ = {}));
/** @internal */
