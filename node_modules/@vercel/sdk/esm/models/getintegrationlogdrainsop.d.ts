 ...
 */
export declare const GetIntegrationLogDrainsCreatedFrom: {
 ...
 * Whether the log drain was created by an integration or by a user
 */
export type GetIntegrationLogDrainsCreatedFrom = ClosedEnum<typeof GetIntegrationLogDrainsCreatedFrom>;
/**
...
/** @internal */
export declare const GetIntegrationLogDrainsCreatedFrom$inboundSchema: z.ZodNativeEnum<typeof GetIntegrationLogDrainsCreatedFrom>;
/** @internal */
export declare const GetIntegrationLogDrainsCreatedFrom$outboundSchema: z.ZodNativeEnum<typeof GetIntegrationLogDrainsCreatedFrom>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace GetIntegrationLogDrainsCreatedFrom$ {
