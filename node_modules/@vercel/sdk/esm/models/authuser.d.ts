...
export type AuthUser = {
     ...
     * A list of projects and spaces across teams that a user has marked as a favorite.
     */
    favoriteProjectsAndSpaces?: Array<FavoriteProjectsAndSpaces1 | FavoriteProjectsAndSpaces2> | undefined;
    /**
...
/** @internal */
export declare const FavoriteProjectsAndSpaces2$inboundSchema: z.ZodType<FavoriteProjectsAndSpaces2, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const FavoriteProjectsAndSpaces2$outboundSchema: z.ZodType<FavoriteProjectsAndSpaces2$Outbound, z.ZodTypeDef, FavoriteProjectsAndSpaces2>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace FavoriteProjectsAndSpaces2$ {
    /** @deprecated use `FavoriteProjectsAndSpaces2$inboundSchema` instead. */
    const inboundSchema: z.ZodType<FavoriteProjectsAndSpaces2, z.ZodTypeDef, unknown>;
    /** @deprecated use `FavoriteProjectsAndSpaces2$outboundSchema` instead. */
    const outboundSchema: z.ZodType<FavoriteProjectsAndSpaces2$Outbound, z.ZodTypeDef, FavoriteProjectsAndSpaces2>;
    /** @deprecated use `FavoriteProjectsAndSpaces2$Outbound` instead. */
    type Outbound = FavoriteProjectsAndSpaces2$Outbound;
}
export declare function favoriteProjectsAndSpaces2ToJSON(favoriteProjectsAndSpaces2: FavoriteProjectsAndSpaces2): string;
export declare function favoriteProjectsAndSpaces2FromJSON(jsonString: string): SafeParseResult<FavoriteProjectsAndSpaces2, SDKValidationError>;
/** @internal */
export declare const FavoriteProjectsAndSpaces1$inboundSchema: z.ZodType<FavoriteProjectsAndSpaces1, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const FavoriteProjectsAndSpaces1$outboundSchema: z.ZodType<FavoriteProjectsAndSpaces1$Outbound, z.ZodTypeDef, FavoriteProjectsAndSpaces1>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace FavoriteProjectsAndSpaces1$ {
    /** @deprecated use `FavoriteProjectsAndSpaces1$inboundSchema` instead. */
    const inboundSchema: z.ZodType<FavoriteProjectsAndSpaces1, z.ZodTypeDef, unknown>;
    /** @deprecated use `FavoriteProjectsAndSpaces1$outboundSchema` instead. */
    const outboundSchema: z.ZodType<FavoriteProjectsAndSpaces1$Outbound, z.ZodTypeDef, FavoriteProjectsAndSpaces1>;
    /** @deprecated use `FavoriteProjectsAndSpaces1$Outbound` instead. */
    type Outbound = FavoriteProjectsAndSpaces1$Outbound;
}
export declare function favoriteProjectsAndSpaces1ToJSON(favoriteProjectsAndSpaces1: FavoriteProjectsAndSpaces1): string;
export declare function favoriteProjectsAndSpaces1FromJSON(jsonString: string): SafeParseResult<FavoriteProjectsAndSpaces1, SDKValidationError>;
/** @internal */
export declare const FavoriteProjectsAndSpaces$inboundSchema: z.ZodType<FavoriteProjectsAndSpaces, z.ZodTypeDef, unknown>;
/** @internal */
export type FavoriteProjectsAndSpaces$Outbound = FavoriteProjectsAndSpaces1$Outbound | FavoriteProjectsAndSpaces2$Outbound;
/** @internal */
...
export type AuthUser$Outbound = {
    ...
    favoriteProjectsAndSpaces?: Array<FavoriteProjectsAndSpaces1$Outbound | FavoriteProjectsAndSpaces2$Outbound> | undefined;
    hasTrialAvailable: boolean;
